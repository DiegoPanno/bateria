...
const AutoPickups = () => {
  ...
  const idCategoria = "auto-pickups"; // Define la categoría que deseas mostrar
  ...
  return (
    <>
      ...
      <div className="conte-cart-auto">
        <h2 className="titulo-auto">Baterías de Auto Pickups</h2>
          ...
          {productos.map((producto) => (
            <div key={producto.id} className="producto-card">
              ...
              <button
                onClick={() =>
                  openWhatsApp(
                    `¡Hola! Consulta por el producto: ${producto.titulo}`,
                  )
                }
